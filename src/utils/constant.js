export default {
  ...
  HOSPITAL_TYPE_WITHOUT_SUBJECT: -1,

  EXPERIMENT_STEP_FILTERING: 10,
  EXPERIMENT_STEP_SCREENING: 20,
  EXPERIMENT_STEP_THERAPY: 30,
  EXPERIMENT_STEP_FOLLOW_UP: 40,
  EXPERIMENT_STEP_COMPLETE: 50,
  ...
  SHOW_GAIT_POSTURE_MODAL: 'showGaitPostureModal',

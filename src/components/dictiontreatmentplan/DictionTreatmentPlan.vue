...
import CommonDrugs from 'components/commondrugs/CommonDrugs';
import ReasonsWithDrawal from 'components/reasonswithdrawal/ReasonsWithDrawal';
import SideEffects from 'components/sideeffects/SideEffects';
import SurgicalProgram from 'components/surgicalprogram/SurgicalProgram';

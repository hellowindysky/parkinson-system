...
import BasicInfoConfig from 'views/configuration/featureconfiguration/basic-info-config/BasicInfoConfig';
import DiseageInfoConfig from 'views/configuration/featureconfiguration/diseage-info-config/DiseageInfoConfig';
import OtherInfoConfig from 'views/configuration/featureconfiguration/other-info-config/OtherInfoConfig';

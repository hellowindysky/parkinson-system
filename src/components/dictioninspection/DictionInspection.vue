...
import LifeCharacteristics from 'components/lifecharacteristics/LifeCharacteristics';
import NervousSystem from 'components/nervoussystem/NervousSystem';
import BiochemicalIndexes from 'components/biochemicalindexes/BiochemicalIndexes';
import Electromyogram from 'components/electromyogram/Electromyogram';

...
<div class="scroll-wrapper">
  <div class="freature-person-conf-wrapper" ref="scrollArea">
    <feature-folding-panel class="common-drugs" :title="'其他用药史'" >
      <el-table :data="tableData">
        <el-table-column prop="xuhao" label="序号" align="center" width="80">
        </el-table-column>
        <el-table-column prop="name" label="药品名称" align="center" width="350">
        </el-table-column>
        <el-table-column prop="tname" label="药物类型" align="center" width="200">
        </el-table-column>
        <el-table-column prop="guige" label="适用疾病" align="center" width="200">
        </el-table-column>
